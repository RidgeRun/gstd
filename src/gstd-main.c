/* gstd-main.c generated by valac 0.14.0, the Vala compiler
...
static void ____lambda0_ (Block1Data* _data1_);
static void _____lambda0__gstd_factory_last_pipe_destroyed (gstdFactory* _sender, gpointer self);
...
static void ____lambda1__gbus_name_acquired_callback (GDBusConnection* connection, const gchar* name, gpointer self);
static void ___lambda2_ (Block1Data* _data1_, GDBusConnection* connection, const gchar* name);
static void ____lambda2__gbus_name_lost_callback (GDBusConnection* connection, const gchar* name, gpointer self);
...
static void ____lambda2__gbus_name_lost_callback (GDBusConnection* connection, const gchar* name, gpointer self) {
	___lambda2_ (self, connection, name);
}
...
gint _vala_main (gchar** args, int args_length1) {
	...
	GError * _inner_error_ = NULL;
	{
		...
		if (_tmp32_) {
			...
			g_signal_connect_data (_tmp33_, "last-pipe-destroyed", (GCallback) _____lambda0__gstd_factory_last_pipe_destroyed, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
		}
		_tmp34_ = connection;
		_tmp35_ = busName;
		g_bus_own_name_on_connection_with_closures (_tmp34_, _tmp35_, G_BUS_NAME_OWNER_FLAGS_NONE, (GClosure*) ((____lambda1__gbus_name_acquired_callback == NULL) ? NULL : g_cclosure_new ((GCallback) ____lambda1__gbus_name_acquired_callback, block1_data_ref (_data1_), block1_data_unref)), (GClosure*) ((____lambda2__gbus_name_lost_callback == NULL) ? NULL : g_cclosure_new ((GCallback) ____lambda2__gbus_name_lost_callback, block1_data_ref (_data1_), block1_data_unref)));
