/* gst-client.c generated by valac 0.11.5, the Vala compiler
...
static void _dynamic_PipelineAsyncPlay3 (DBusGProxy* self, GError** error);
static gboolean gstd_cli_pipeline_ready (GstdCli* self, DBusGProxy* pipeline, gboolean sync);
static gboolean _dynamic_PipelineReady4 (DBusGProxy* self, GError** error);
static void _dynamic_PipelineAsyncReady5 (DBusGProxy* self, GError** error);
static gboolean gstd_cli_pipeline_pause (GstdCli* self, DBusGProxy* pipeline, gboolean sync);
static gboolean _dynamic_PipelinePause6 (DBusGProxy* self, GError** error);
static void _dynamic_PipelineAsyncPause7 (DBusGProxy* self, GError** error);
static gboolean gstd_cli_pipeline_null (GstdCli* self, DBusGProxy* pipeline, gboolean sync);
static gboolean _dynamic_PipelineNull8 (DBusGProxy* self, GError** error);
static void _dynamic_PipelineAsyncNull9 (DBusGProxy* self, GError** error);
...
static gboolean _dynamic_ElementSetState26 (DBusGProxy* self, const gchar* param1, gint param2, GError** error);
static gboolean gstd_cli_element_async_set_state (GstdCli* self, DBusGProxy* pipeline, gchar** args, int args_length1);
static gboolean _dynamic_ElementAsyncSetState27 (DBusGProxy* self, const gchar* param1, gint param2, GError** error);
...
static gchar** _dynamic_List28 (DBusGProxy* self, int* result_length1, GError** error);
...
static void _dynamic_PipelineAsyncPlay3 (DBusGProxy* self, GError** error) {
	dbus_g_proxy_call (self, "PipelineAsyncPlay", error, G_TYPE_INVALID, G_TYPE_INVALID);
	if (*error) {
		return;
	}
}
...
static gboolean gstd_cli_pipeline_play (GstdCli* self, DBusGProxy* pipeline, gboolean sync) {
	...
	if (sync) {
		...
		_dynamic_PipelineAsyncPlay3 (pipeline, &_inner_error_);
		if (_inner_error_ != NULL) {
			goto __catch1_g_error;
		}
	}
...
static gboolean _dynamic_PipelineReady4 (DBusGProxy* self, GError** error) {
	gboolean result;
	dbus_g_proxy_call (self, "PipelineReady", error, G_TYPE_INVALID, G_TYPE_BOOLEAN, &result, G_TYPE_INVALID);
	if (*error) {
		return FALSE;
	}
	return result;
...
static void _dynamic_PipelineAsyncReady5 (DBusGProxy* self, GError** error) {
	dbus_g_proxy_call (self, "PipelineAsyncReady", error, G_TYPE_INVALID, G_TYPE_INVALID);
	if (*error) {
		return;
	}
}
...
static gboolean gstd_cli_pipeline_ready (GstdCli* self, DBusGProxy* pipeline, gboolean sync) {
	...
	if (sync) {
		gboolean _tmp0_;
		gboolean ret;
		_tmp0_ = _dynamic_PipelineReady4 (pipeline, &_inner_error_);
		ret = _tmp0_;
		if (_inner_error_ != NULL) {
		...
		_dynamic_PipelineAsyncReady5 (pipeline, &_inner_error_);
		if (_inner_error_ != NULL) {
			goto __catch2_g_error;
		}
	}
...
static void _dynamic_PipelineAsyncPause7 (DBusGProxy* self, GError** error) {
	dbus_g_proxy_call (self, "PipelineAsyncPause", error, G_TYPE_INVALID, G_TYPE_INVALID);
	if (*error) {
		return;
	}
}
...
static gboolean gstd_cli_pipeline_pause (GstdCli* self, DBusGProxy* pipeline, gboolean sync) {
	...
	if (sync) {
		gboolean _tmp0_;
		gboolean ret;
		_tmp0_ = _dynamic_PipelinePause6 (pipeline, &_inner_error_);
		ret = _tmp0_;
		if (_inner_error_ != NULL) {
		...
		_dynamic_PipelineAsyncPause7 (pipeline, &_inner_error_);
		if (_inner_error_ != NULL) {
			goto __catch3_g_error;
		}
	}
...
static void _dynamic_PipelineAsyncNull9 (DBusGProxy* self, GError** error) {
	dbus_g_proxy_call (self, "PipelineAsyncNull", error, G_TYPE_INVALID, G_TYPE_INVALID);
	if (*error) {
		return;
	}
}
...
static gboolean gstd_cli_pipeline_null (GstdCli* self, DBusGProxy* pipeline, gboolean sync) {
	...
	if (sync) {
		gboolean _tmp0_;
		gboolean ret;
		_tmp0_ = _dynamic_PipelineNull8 (pipeline, &_inner_error_);
		ret = _tmp0_;
		if (_inner_error_ != NULL) {
		...
		_dynamic_PipelineAsyncNull9 (pipeline, &_inner_error_);
		if (_inner_error_ != NULL) {
			goto __catch4_g_error;
		}
	}
...
static gboolean gstd_cli_element_set_state (GstdCli* self, DBusGProxy* pipeline, gchar** args, int args_length1) {
	...
	state = _tmp2_;
	_tmp3_ = _dynamic_ElementSetState26 (pipeline, element, state, &_inner_error_);
	_tmp4_ = _tmp3_;
	if (_inner_error_ != NULL) {
		_g_free0 (element);
		g_critical ("file %s: line %d: uncaught error: %s (%s, %d)", __FILE__, __LINE__, _inner_error_->message, g_quark_to_string (_inner_error_->domain), _inner_error_->code);
...
static gboolean gstd_cli_element_async_set_state (GstdCli* self, DBusGProxy* pipeline, gchar** args, int args_length1) {
	...
	_tmp2_ = gstd_cli_string_to_state (self, args[2]);
	state = _tmp2_;
	_tmp3_ = _dynamic_ElementAsyncSetState27 (pipeline, element, state, &_inner_error_);
	_tmp4_ = _tmp3_;
	if (_inner_error_ != NULL) {
		_g_free0 (element);
		g_critical ("file %s: line %d: uncaught error: %s (%s, %d)", __FILE__, __LINE__, _inner_error_->message, g_quark_to_string (_inner_error_->domain), _inner_error_->code);
...
static gboolean gstd_cli_pipeline_list (GstdCli* self) {
	...
	GError * _inner_error_ = NULL;
	g_return_val_if_fail (self != NULL, FALSE);
	_tmp1_ = _dynamic_List28 (self->priv->factory, &_tmp0_, &_inner_error_);
	paths = _tmp1_;
...
gboolean gstd_cli_create_proxypipe (GstdCli* self, const gchar* object_path) {
	...
	_tmp2_ = _dynamic_PipelineIsInitialized29 (self->priv->pipeline, &_inner_error_);
	ret = _tmp2_;
	if (_inner_error_ != NULL) {
...
gboolean gstd_cli_parse_cmd (GstdCli* self, gchar** args, int args_length1, GError** error) {
	...
	if (!_tmp0_) {
		...
		gchar* _tmp10_;
		gboolean _tmp11_;
		_tmp9_ = g_utf8_strdown (args[0], (gssize) (-1));
		_tmp10_ = _tmp9_;
		if ((_tmp11_ = g_strcmp0 (_tmp10_, "create") != 0, _g_free0 (_tmp10_), _tmp11_)) {
			gchar* _tmp12_ = NULL;
			gchar* _tmp13_;
			_tmp12_ = g_utf8_strdown (args[0], (gssize) (-1));
			_tmp13_ = _tmp12_;
			_tmp8_ = g_strcmp0 (_tmp13_, "help") != 0;
			_g_free0 (_tmp13_);
		} else {
			_tmp8_ = FALSE;
		}
		if (_tmp8_) {
			...
			_tmp15_ = _tmp14_;
			_tmp7_ = g_strcmp0 (_tmp15_, "active") != 0;
			_g_free0 (_tmp15_);
		} else {
			_tmp7_ = FALSE;
		}
		if (_tmp7_) {
			...
			_tmp17_ = _tmp16_;
			_tmp6_ = g_strcmp0 (_tmp17_, "quit") != 0;
			_g_free0 (_tmp17_);
		} else {
			_tmp6_ = FALSE;
		}
		if (_tmp6_) {
			...
			_tmp19_ = _tmp18_;
			_tmp5_ = g_strcmp0 (_tmp19_, "list-pipes") != 0;
			_g_free0 (_tmp19_);
		} else {
			_tmp5_ = FALSE;
		}
		if (_tmp5_) {
			...
			_tmp21_ = _tmp20_;
			_tmp4_ = g_strcmp0 (_tmp21_, "ping") != 0;
			_g_free0 (_tmp21_);
		} else {
			_tmp4_ = FALSE;
		}
		if (_tmp4_) {
			...
			_tmp23_ = _tmp22_;
			_tmp3_ = g_strcmp0 (_tmp23_, "exit") != 0;
			_g_free0 (_tmp23_);
		} else {
			_tmp3_ = FALSE;
		}
		...
		if (gstd_cli__signals) {
			...
			_tmp28_ = _tmp27_;
			if ((_tmp29_ = g_strcmp0 (_tmp28_, "create") != 0, _g_free0 (_tmp28_), _tmp29_)) {
				gchar* _tmp30_ = NULL;
				gchar* _tmp31_;
				_tmp30_ = g_utf8_strdown (args[0], (gssize) (-1));
				_tmp31_ = _tmp30_;
				_tmp26_ = g_strcmp0 (_tmp31_, "help") != 0;
				_g_free0 (_tmp31_);
			} else {
				_tmp26_ = FALSE;
			}
	...
	} else if (_tmp34_ == ((0 != _tmp34__label15) ? _tmp34__label15 : (_tmp34__label15 = g_quark_from_static_string ("sh")))) {
		switch (0) {
			default:
			{
				gchar** command = NULL;
				...
				gchar** _tmp62_;
				gboolean _tmp63_;
				_tmp58_ = g_strjoinv (" ", args);
				_tmp59_ = _tmp58_;
				_tmp61_ = _tmp60_ = g_strsplit (_tmp59_, "\"", -1);
				_tmp62_ = _tmp61_;
				command = (_vala_array_free (command, command_length1, (GDestroyNotify) g_free), NULL);
				command_length1 = _vala_array_length (_tmp60_);
				_command_size_ = command_length1;
				command = _tmp62_;
				_g_free0 (_tmp59_);
				_tmp63_ = gstd_cli_shell (self, command[1]);
				result = _tmp63_;
				command = (_vala_array_free (command, command_length1, (GDestroyNotify) g_free), NULL);
				return result;
			}
		}
	} else if (_tmp34_ == ((0 != _tmp34__label16) ? _tmp34__label16 : (_tmp34__label16 = g_quark_from_static_string ("seek")))) {
		switch (0) {
			default:
			{
				gboolean _tmp64_;
				_tmp64_ = gstd_cli_pipeline_seek (self, self->priv->pipeline, args, args_length1);
				result = _tmp64_;
				return result;
			}
		}
	} else if (_tmp34_ == ((0 != _tmp34__label17) ? _tmp34__label17 : (_tmp34__label17 = g_quark_from_static_string ("skip")))) {
		switch (0) {
			default:
			{
				gboolean _tmp65_;
				_tmp65_ = gstd_cli_pipeline_skip (self, self->priv->pipeline, args, args_length1);
				result = _tmp65_;
				return result;
			}
		}
	} else if (_tmp34_ == ((0 != _tmp34__label18) ? _tmp34__label18 : (_tmp34__label18 = g_quark_from_static_string ("speed")))) {
		switch (0) {
			default:
			{
				gboolean _tmp66_;
				_tmp66_ = gstd_cli_pipeline_speed (self, self->priv->pipeline, args, args_length1);
				result = _tmp66_;
				return result;
			}
		}
	} else if (_tmp34_ == ((0 != _tmp34__label19) ? _tmp34__label19 : (_tmp34__label19 = g_quark_from_static_string ("send-eos")))) {
		switch (0) {
			default:
			{
				gboolean _tmp67_;
				_tmp67_ = gstd_cli_pipeline_send_eos (self, self->priv->pipeline, args, args_length1);
				result = _tmp67_;
				return result;
			}
		}
	} else if (_tmp34_ == ((0 != _tmp34__label20) ? _tmp34__label20 : (_tmp34__label20 = g_quark_from_static_string ("list-pipes")))) {
		switch (0) {
			default:
			{
				gboolean _tmp68_;
				_tmp68_ = gstd_cli_pipeline_list (self);
				result = _tmp68_;
				return result;
			}
		}
	} else if (_tmp34_ == ((0 != _tmp34__label21) ? _tmp34__label21 : (_tmp34__label21 = g_quark_from_static_string ("ping")))) {
		switch (0) {
			default:
			{
				gboolean _tmp69_;
				_tmp69_ = gstd_cli_gstd_ping (self);
				result = _tmp69_;
				return result;
			}
		}
	} else if (_tmp34_ == ((0 != _tmp34__label22) ? _tmp34__label22 : (_tmp34__label22 = g_quark_from_static_string ("active")))) {
		switch (0) {
			default:
			{
				if (args[1] == NULL) {
					gboolean _tmp70_;
					_tmp70_ = gstd_cli_get_active (self);
					result = _tmp70_;
					return result;
				} else {
					gboolean _tmp71_;
					_tmp71_ = gstd_cli_set_active (self, args[1]);
					result = _tmp71_;
					return result;
				}
			}
		}
	} else if (_tmp34_ == ((0 != _tmp34__label23) ? _tmp34__label23 : (_tmp34__label23 = g_quark_from_static_string ("element-set-state")))) {
		switch (0) {
			default:
			{
				gboolean _tmp72_;
				_tmp72_ = gstd_cli_element_set_state (self, self->priv->pipeline, args, args_length1);
				result = _tmp72_;
				return result;
			}
		}
	} else if (_tmp34_ == ((0 != _tmp34__label24) ? _tmp34__label24 : (_tmp34__label24 = g_quark_from_static_string ("element-async-set-state")))) {
		switch (0) {
			default:
			{
				gboolean _tmp73_;
				_tmp73_ = gstd_cli_element_async_set_state (self, self->priv->pipeline, args, args_length1);
				result = _tmp73_;
				return result;
			}
		}
	...
	} else if (_tmp34_ == ((0 != _tmp34__label27) ? _tmp34__label27 : (_tmp34__label27 = g_quark_from_static_string ("help")))) {
		switch (0) {
			default:
			{
				gint id;
				...
				if (args_length1 > 1) {
					...
					while (TRUE) {
						...
						_tmp75_ = strlen (self->priv->cmds[(id * self->priv->cmds_length2) + 0]);
						if (_tmp75_ < 6) {
							_tmp74_ = "\t\t";
						} else {
							_tmp74_ = "\t";
						}
						fprintf (stdout, " %s:%s%s\n", self->priv->cmds[(id * self->priv->cmds_length2) + 0], _tmp74_, self->priv->cmds[(id * self->priv->cmds_length2) + 2]);
						id++;
					}
					fprintf (stdout, "\n");
				}
...
gboolean gstd_cli_cli (GstdCli* self, GError** error) {
	...
	_tmp12_ = g_strconcat (home, "/.gst-client_history", NULL);
...
static void gstd_cli_instance_init (GstdCli * self) {
	...
	_tmp69_ = g_strdup ("element-set-state");
	_tmp70_ = g_strdup ("element-set-state <element_name> <state>");
	_tmp71_ = g_strdup ("Sets the element state" "\t\tSupported <state>s include: null, ready, paused, playing");
	_tmp72_ = g_strdup ("element-async-set-state");
	_tmp73_ = g_strdup ("element-async-set-state <element_name> <state>");
	_tmp74_ = g_strdup ("Sets the element state, it does not wait the change to be done");
