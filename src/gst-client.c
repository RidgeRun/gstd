...
static gchar** _dynamic_List26 (DBusGProxy* self, int* result_length1, GError** error);
...
static gboolean _dynamic_PipelineIsInitialized27 (DBusGProxy* self, GError** error);
...
gboolean gstd_cli_parse (GstdCli* self, gchar** args, int args_length1, GError** error);
...
GstdCli* gstd_cli_construct (GType object_type, gchar** args, int args_length1, GError** error) {
	...
	gstd_cli_isInteractive = !(_vala_array_length (gstd_cli__remaining_args) == 1);
...
static gboolean gstd_cli_pipeline_seek (GstdCli* self, DBusGProxy* pipeline, gchar** args, int args_length1) {
	...
	_tmp1_ = _dynamic_PipelineSeek22 (pipeline, pos_ms, &_inner_error_);
	ret = _tmp1_;
	if (_inner_error_ != NULL) {
		g_critical ("file %s: line %d: uncaught error: %s (%s, %d)", __FILE__, __LINE__, _inner_error_->message, g_quark_to_string (_inner_error_->domain), _inner_error_->code);
		g_clear_error (&_inner_error_);
...
static gboolean gstd_cli_pipeline_skip (GstdCli* self, DBusGProxy* pipeline, gchar** args, int args_length1) {
	...
	_tmp1_ = _dynamic_PipelineSkip23 (pipeline, period_ms, &_inner_error_);
	ret = _tmp1_;
	if (_inner_error_ != NULL) {
		g_critical ("file %s: line %d: uncaught error: %s (%s, %d)", __FILE__, __LINE__, _inner_error_->message, g_quark_to_string (_inner_error_->domain), _inner_error_->code);
		g_clear_error (&_inner_error_);
...
static gboolean gstd_cli_pipeline_speed (GstdCli* self, DBusGProxy* pipeline, gchar** args, int args_length1) {
	...
	rate = _tmp0_;
	_tmp1_ = _dynamic_PipelineSpeed24 (pipeline, rate, &_inner_error_);
	ret = _tmp1_;
	if (_inner_error_ != NULL) {
		g_critical ("file %s: line %d: uncaught error: %s (%s, %d)", __FILE__, __LINE__, _inner_error_->message, g_quark_to_string (_inner_error_->domain), _inner_error_->code);
		g_clear_error (&_inner_error_);
...
static gboolean gstd_cli_pipeline_send_eos (GstdCli* self, DBusGProxy* pipeline, gchar** args, int args_length1) {
	...
	g_return_val_if_fail (self != NULL, FALSE);
	g_return_val_if_fail (pipeline != NULL, FALSE);
	_dynamic_PipelineSendEoS25 (pipeline, &_inner_error_);
	if (_inner_error_ != NULL) {
		g_critical ("file %s: line %d: uncaught error: %s (%s, %d)", __FILE__, __LINE__, _inner_error_->message, g_quark_to_string (_inner_error_->domain), _inner_error_->code);
		g_clear_error (&_inner_error_);
		return FALSE;
...
static gboolean gstd_cli_pipeline_list (GstdCli* self) {
	...
	GError * _inner_error_ = NULL;
	g_return_val_if_fail (self != NULL, FALSE);
	_tmp1_ = _dynamic_List26 (self->priv->factory, &_tmp0_, &_inner_error_);
	_tmp2_ = _tmp1_;
...
gboolean gstd_cli_create_proxypipe (GstdCli* self, const gchar* object_path) {
	...
	_tmp2_ = _dynamic_PipelineIsInitialized27 (self->priv->pipeline, &_inner_error_);
	ret = _tmp2_;
	if (_inner_error_ != NULL) {
...
void _dynamic_Error1_connect (gpointer obj, const char * signal_name, GCallback handler, gpointer data) {
	...
	dbus_g_proxy_connect_signal (obj, "Error", handler, data, NULL);
}
...
void _dynamic_Eos3_connect (gpointer obj, const char * signal_name, GCallback handler, gpointer data) {
	...
	dbus_g_proxy_connect_signal (obj, "Eos", handler, data, NULL);
}
...
void _dynamic_StateChanged5_connect (gpointer obj, const char * signal_name, GCallback handler, gpointer data) {
	...
	dbus_g_proxy_connect_signal (obj, "StateChanged", handler, data, NULL);
}
...
gboolean gstd_cli_parse_cmd (GstdCli* self, gchar** args, int args_length1, GError** error) {
	...
	if (!_tmp0_) {
		...
		if (gstd_cli__signals) {
			...
			_tmp31_ = _tmp30_;
			if ((_tmp32_ = g_strcmp0 (_tmp31_, "create") != 0, _g_free0 (_tmp31_), _tmp32_)) {
				gchar* _tmp33_ = NULL;
				gchar* _tmp34_;
				_tmp33_ = g_utf8_strdown (args[0], (gssize) (-1));
				_tmp34_ = _tmp33_;
				_tmp29_ = g_strcmp0 (_tmp34_, "help") != 0;
				_g_free0 (_tmp34_);
			} else {
				_tmp29_ = FALSE;
			}
	...
	} else if (_tmp37_ == ((0 != _tmp37__label2) ? _tmp37__label2 : (_tmp37__label2 = g_quark_from_static_string ("play")))) {
		switch (0) {
			default:
			{
				gboolean _tmp48_;
				_tmp48_ = gstd_cli_pipeline_play (self, self->priv->pipeline, TRUE);
				result = _tmp48_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label3) ? _tmp37__label3 : (_tmp37__label3 = g_quark_from_static_string ("ready")))) {
		switch (0) {
			default:
			{
				gboolean _tmp49_;
				_tmp49_ = gstd_cli_pipeline_ready (self, self->priv->pipeline, TRUE);
				result = _tmp49_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label4) ? _tmp37__label4 : (_tmp37__label4 = g_quark_from_static_string ("pause")))) {
		switch (0) {
			default:
			{
				gboolean _tmp50_;
				_tmp50_ = gstd_cli_pipeline_pause (self, self->priv->pipeline, TRUE);
				result = _tmp50_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label5) ? _tmp37__label5 : (_tmp37__label5 = g_quark_from_static_string ("null")))) {
		switch (0) {
			default:
			{
				gboolean _tmp51_;
				_tmp51_ = gstd_cli_pipeline_null (self, self->priv->pipeline, TRUE);
				result = _tmp51_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label6) ? _tmp37__label6 : (_tmp37__label6 = g_quark_from_static_string ("aplay")))) {
		switch (0) {
			default:
			{
				gboolean _tmp52_;
				_tmp52_ = gstd_cli_pipeline_play (self, self->priv->pipeline, FALSE);
				result = _tmp52_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label7) ? _tmp37__label7 : (_tmp37__label7 = g_quark_from_static_string ("aready")))) {
		switch (0) {
			default:
			{
				gboolean _tmp53_;
				_tmp53_ = gstd_cli_pipeline_ready (self, self->priv->pipeline, FALSE);
				result = _tmp53_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label8) ? _tmp37__label8 : (_tmp37__label8 = g_quark_from_static_string ("apause")))) {
		switch (0) {
			default:
			{
				gboolean _tmp54_;
				_tmp54_ = gstd_cli_pipeline_pause (self, self->priv->pipeline, FALSE);
				result = _tmp54_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label9) ? _tmp37__label9 : (_tmp37__label9 = g_quark_from_static_string ("anull")))) {
		switch (0) {
			default:
			{
				gboolean _tmp55_;
				_tmp55_ = gstd_cli_pipeline_null (self, self->priv->pipeline, FALSE);
				result = _tmp55_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label10) ? _tmp37__label10 : (_tmp37__label10 = g_quark_from_static_string ("set")))) {
		switch (0) {
			default:
			{
				gboolean _tmp56_;
				_tmp56_ = gstd_cli_pipeline_set_property (self, self->priv->pipeline, args, args_length1);
				result = _tmp56_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label11) ? _tmp37__label11 : (_tmp37__label11 = g_quark_from_static_string ("get")))) {
		switch (0) {
			default:
			{
				gboolean _tmp57_;
				_tmp57_ = gstd_cli_pipeline_get_property (self, self->priv->pipeline, args, args_length1);
				result = _tmp57_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label12) ? _tmp37__label12 : (_tmp37__label12 = g_quark_from_static_string ("get-duration")))) {
		switch (0) {
			default:
			{
				gboolean _tmp58_;
				_tmp58_ = gstd_cli_pipeline_get_duration (self, self->priv->pipeline);
				result = _tmp58_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label13) ? _tmp37__label13 : (_tmp37__label13 = g_quark_from_static_string ("get-position")))) {
		switch (0) {
			default:
			{
				gboolean _tmp59_;
				_tmp59_ = gstd_cli_pipeline_get_position (self, self->priv->pipeline);
				result = _tmp59_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label14) ? _tmp37__label14 : (_tmp37__label14 = g_quark_from_static_string ("get-state")))) {
		switch (0) {
			default:
			{
				gboolean _tmp60_;
				_tmp60_ = gstd_cli_pipeline_get_state (self, self->priv->pipeline);
				result = _tmp60_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label15) ? _tmp37__label15 : (_tmp37__label15 = g_quark_from_static_string ("sh")))) {
		switch (0) {
			default:
			{
				...
				command_length1 = 0;
				command = NULL;
				_tmp61_ = g_strjoinv (" ", args);
				_tmp62_ = _tmp61_;
				_tmp64_ = _tmp63_ = g_strsplit (_tmp62_, "\"", -1);
				_tmp65_ = _tmp64_;
				command = (_vala_array_free (command, command_length1, (GDestroyNotify) g_free), NULL);
				command_length1 = _vala_array_length (_tmp63_);
				_command_size_ = command_length1;
				command = _tmp65_;
				_g_free0 (_tmp62_);
				_tmp66_ = gstd_cli_shell (self, command[1]);
				result = _tmp66_;
				command = (_vala_array_free (command, command_length1, (GDestroyNotify) g_free), NULL);
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label16) ? _tmp37__label16 : (_tmp37__label16 = g_quark_from_static_string ("seek")))) {
		switch (0) {
			default:
			{
				gboolean _tmp67_;
				_tmp67_ = gstd_cli_pipeline_seek (self, self->priv->pipeline, args, args_length1);
				result = _tmp67_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label17) ? _tmp37__label17 : (_tmp37__label17 = g_quark_from_static_string ("skip")))) {
		switch (0) {
			default:
			{
				gboolean _tmp68_;
				_tmp68_ = gstd_cli_pipeline_skip (self, self->priv->pipeline, args, args_length1);
				result = _tmp68_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label18) ? _tmp37__label18 : (_tmp37__label18 = g_quark_from_static_string ("speed")))) {
		switch (0) {
			default:
			{
				gboolean _tmp69_;
				_tmp69_ = gstd_cli_pipeline_speed (self, self->priv->pipeline, args, args_length1);
				result = _tmp69_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label19) ? _tmp37__label19 : (_tmp37__label19 = g_quark_from_static_string ("send-eos")))) {
		switch (0) {
			default:
			{
				gboolean _tmp70_;
				_tmp70_ = gstd_cli_pipeline_send_eos (self, self->priv->pipeline, args, args_length1);
				result = _tmp70_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label20) ? _tmp37__label20 : (_tmp37__label20 = g_quark_from_static_string ("list-pipes")))) {
		switch (0) {
			default:
			{
				gboolean _tmp71_;
				_tmp71_ = gstd_cli_pipeline_list (self);
				result = _tmp71_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label21) ? _tmp37__label21 : (_tmp37__label21 = g_quark_from_static_string ("ping")))) {
		switch (0) {
			default:
			{
				gboolean _tmp72_;
				_tmp72_ = gstd_cli_gstd_ping (self);
				result = _tmp72_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label22) ? _tmp37__label22 : (_tmp37__label22 = g_quark_from_static_string ("active")))) {
		switch (0) {
			default:
			{
				if (args[1] == NULL) {
					gboolean _tmp73_;
					_tmp73_ = gstd_cli_get_active (self);
					result = _tmp73_;
					return result;
				} else {
					gboolean _tmp74_;
					_tmp74_ = gstd_cli_set_active (self, args[1]);
					result = _tmp74_;
					return result;
				}
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label23) ? _tmp37__label23 : (_tmp37__label23 = g_quark_from_static_string ("quit")))) {
		switch (0) {
			default:
			{
	...
	} else if (_tmp37_ == ((0 != _tmp37__label24) ? _tmp37__label24 : (_tmp37__label24 = g_quark_from_static_string ("exit")))) {
		switch (0) {
			default:
			{
				self->priv->cli_enable = FALSE;
	...
	} else if (_tmp37_ == ((0 != _tmp37__label25) ? _tmp37__label25 : (_tmp37__label25 = g_quark_from_static_string ("strict")))) {
		switch (0) {
			default:
			{
				gboolean _tmp75_;
				_tmp75_ = gstd_cli_set_strict (self, args, args_length1);
				result = _tmp75_;
				return result;
			}
		}
	} else if (_tmp37_ == ((0 != _tmp37__label26) ? _tmp37__label26 : (_tmp37__label26 = g_quark_from_static_string ("help")))) {
		switch (0) {
			default:
			{
				gint id;
				...
				if (args_length1 > 1) {
					...
					while (TRUE) {
						...
						_tmp76_ = NULL;
						_tmp77_ = strlen (self->priv->cmds[(id * self->priv->cmds_length2) + 0]);
						if (_tmp77_ < 6) {
							_tmp76_ = "\t\t";
						} else {
							_tmp76_ = "\t";
						}
						fprintf (stdout, " %s:%s%s\n", self->priv->cmds[(id * self->priv->cmds_length2) + 0], _tmp76_, self->priv->cmds[(id * self->priv->cmds_length2) + 2]);
						id++;
					}
					fprintf (stdout, "\n");
				}
...
gboolean gstd_cli_parse (GstdCli* self, gchar** args, int args_length1, GError** error) {
	...
	if (gstd_cli_isInteractive) {
		...
		gboolean _tmp8_;
		gboolean _tmp9_;
		_tmp4_ = fopen (gstd_cli__remaining_args[_vala_array_length (gstd_cli__remaining_args) - 1], "r");
		_tmp5_ = _tmp4_;
...
static void gstd_cli_instance_init (GstdCli * self) {
	...
	_tmp48_ = g_strdup ("list-pipes");
	_tmp49_ = g_strdup ("list-pipes");
	_tmp50_ = g_strdup ("Returns a list of all the dbus-path of" "the existing pipelines");
	_tmp51_ = g_strdup ("ping");
	_tmp52_ = g_strdup ("ping");
	_tmp53_ = g_strdup ("Shows if gstd is alive");
	_tmp54_ = g_strdup ("active");
	_tmp55_ = g_strdup ("active <path>");
	_tmp56_ = g_strdup ("Sets the active pipeline,if no <path> is " "passed:it returns the actual active pipeline");
	_tmp57_ = g_strdup ("seek");
	_tmp58_ = g_strdup ("seek <position[ms]>");
	_tmp59_ = g_strdup ("Moves current playing position to a new" " one");
	_tmp60_ = g_strdup ("skip");
	_tmp61_ = g_strdup ("skip <period[ms]>");
	_tmp62_ = g_strdup ("Skips a period, if period is positive: it" " moves forward, if negative: it moves backward");
	_tmp63_ = g_strdup ("speed");
	_tmp64_ = g_strdup ("speed <rate>");
	_tmp65_ = g_strdup ("Changes playback rate:\n" "\t\t* rate>1.0: fast-forward playback,\n" "\t\t* rate<1.0: slow-forward playback,\n" "\t\t* rate=1.0: normal speed.\n" "\t\tNegative rate causes reverse playback.");
	_tmp66_ = g_strdup ("send-eos");
	_tmp67_ = g_strdup ("send-eos");
	_tmp68_ = g_strdup ("Send an EOS event on the pipeline");
	_tmp69_ = g_strdup ("exit");
	_tmp70_ = g_strdup ("exit");
	_tmp71_ = g_strdup ("Exit/quit active console");
	_tmp72_ = g_strdup ("quit");
	_tmp73_ = g_strdup ("quit");
	_tmp74_ = g_strdup ("Exit/quit active console");
	_tmp75_ = g_strdup ("strict");
	_tmp76_ = g_strdup ("strict");
	_tmp77_ = g_strdup ("Enable/disable strict execution mode.");
	_tmp78_ = g_new0 (gchar*, (26 * 3) + 1);
	_tmp78_[0] = _tmp0_;
	_tmp78_[1] = _tmp1_;
	_tmp78_[2] = _tmp2_;
	_tmp78_[3] = _tmp3_;
	...
	_tmp78_[76] = _tmp76_;
	_tmp78_[77] = _tmp77_;
	self->priv->cmds = _tmp78_;
	self->priv->cmds_length1 = 26;
