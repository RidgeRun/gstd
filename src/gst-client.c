...
void gstd_cli_parse_options (GstdCli* self, gchar** args, int args_length1);
...
void gstd_cli_parse_options (GstdCli* self, gchar** args, int args_length1) {
	...
	_tmp2_ = g_option_context_new ("(For Commands HELP: 'gst-client help')");
	opt = _tmp2_;
...
static void gstd_cli_instance_init (GstdCli * self) {
	...
	_tmp62_ = g_strdup ("Skips a period, if period is positive: it" " moves foward, if negative: it moves backward");
	...
	_tmp68_ = g_strdup ("Exit active console");
	_tmp69_ = g_strdup ("quit");
	_tmp70_ = g_strdup ("quit");
	_tmp71_ = g_strdup ("Quit active console");
