...
gint _vala_main (gchar** args, int args_length1) {
	...
	GError * _inner_error_ = NULL;
	{
		...
		_tmp31_ = connection;
		g_bus_own_name_on_connection_with_closures (_tmp31_, "com.ridgerun.gstreamer.gstd", G_BUS_NAME_OWNER_FLAGS_NONE, (GClosure*) ((____lambda2__gbus_name_acquired_callback == NULL) ? NULL : g_cclosure_new ((GCallback) ____lambda2__gbus_name_acquired_callback, block1_data_ref (_data1_), block1_data_unref)), (GClosure*) ((____lambda3__gbus_name_lost_callback == NULL) ? NULL : g_cclosure_new ((GCallback) ____lambda3__gbus_name_lost_callback, block1_data_ref (_data1_), block1_data_unref)));
