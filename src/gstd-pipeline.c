/* gstd-pipeline.c generated by valac 0.11.5, the Vala compiler
...
static GstState pipeline_EnumToGstState (Pipeline* self, gint state);
...
static GstState pipeline_EnumToGstState (Pipeline* self, gint state) {
	...
	switch (state) {
		...
		case 2:
		{
			result = GST_STATE_READY;
			return result;
		}
		case 3:
		{
			result = GST_STATE_PAUSED;
			return result;
		}
		case 4:
		{
			result = GST_STATE_PLAYING;
			return result;
		}
		default:
		{
			result = GST_STATE_VOID_PENDING;
			return result;
		}
	}
}
...
gboolean pipeline_PipelinePlay (Pipeline* self) {
	...
	gboolean _tmp0_;
	g_return_val_if_fail (self != NULL, FALSE);
	_tmp0_ = pipeline_PipelineSetState (self, GST_STATE_PLAYING);
	result = _tmp0_;
	return result;
}
...
gboolean pipeline_PipelineReady (Pipeline* self) {
	...
	gboolean _tmp0_;
	g_return_val_if_fail (self != NULL, FALSE);
	_tmp0_ = pipeline_PipelineSetState (self, GST_STATE_READY);
	result = _tmp0_;
	return result;
}
...
gboolean pipeline_PipelinePause (Pipeline* self) {
	...
	gboolean _tmp0_;
	g_return_val_if_fail (self != NULL, FALSE);
	_tmp0_ = pipeline_PipelineSetState (self, GST_STATE_PAUSED);
	result = _tmp0_;
	return result;
}
...
gboolean pipeline_PipelineNull (Pipeline* self) {
	...
	gboolean _tmp0_;
	g_return_val_if_fail (self != NULL, FALSE);
	_tmp0_ = pipeline_PipelineSetState (self, GST_STATE_NULL);
	result = _tmp0_;
	return result;
}
...
gboolean pipeline_ElementSetState (Pipeline* self, const gchar* element, gint state) {
	...
	_tmp6_ = pipeline_EnumToGstState (self, state);
	gst_element_set_state (e, _tmp6_);
	gst_element_get_state (e, &_tmp7_, &_tmp8_, (GstClockTime) 4000000000U);
	current = _tmp7_;
	pending = _tmp8_;
	gst_element_get_state (e, &_tmp9_, &_tmp10_, (GstClockTime) 4000000000U);
	current = _tmp9_;
	pending = _tmp10_;
	if (current != state) {
		if (self->priv->debug) {
			gchar* _tmp11_ = NULL;
			gchar* _tmp12_;
			_tmp11_ = g_strdup_printf ("%i", state);
			_tmp12_ = _tmp11_;
			syslog (LOG_ERR, "Element, failed to change state %s", _tmp12_, NULL);
			_g_free0 (_tmp12_);
		}
		result = FALSE;
		_gst_object_unref0 (pipe);
...
static void pipeline_finalize (GObject* obj) {
	...
	if (_tmp0_) {
		gboolean _tmp1_;
		_tmp1_ = pipeline_PipelineSetState (self, GST_STATE_NULL);
		if (!_tmp1_) {
...
static DBusHandlerResult _dbus_pipeline_PipelineGetId (Pipeline* self, DBusConnection* connection, DBusMessage* message) {
	...
	dbus_message_iter_init_append (reply, &iter);
	_tmp2_ = result;
	dbus_message_iter_append_basic (&iter, DBUS_TYPE_UINT64, &_tmp2_);
	if (reply) {
		dbus_connection_send (connection, reply, NULL);
		dbus_message_unref (reply);
		return DBUS_HANDLER_RESULT_HANDLED;
...
static DBusHandlerResult _dbus_pipeline_ElementSetPropertyInt (Pipeline* self, DBusConnection* connection, DBusMessage* message) {
	...
	dbus_message_iter_next (&iter);
	element = g_strdup (_tmp16_);
	dbus_message_iter_get_basic (&iter, &_tmp17_);
	dbus_message_iter_next (&iter);
	property = g_strdup (_tmp17_);
...
static DBusHandlerResult _dbus_pipeline_ElementSetPropertyInt64 (Pipeline* self, DBusConnection* connection, DBusMessage* message) {
	...
	dbus_message_iter_next (&iter);
	element = g_strdup (_tmp20_);
	dbus_message_iter_get_basic (&iter, &_tmp21_);
	dbus_message_iter_next (&iter);
	property = g_strdup (_tmp21_);
	...
	_g_free0 (property);
	_tmp23_ = result;
	dbus_message_iter_append_basic (&iter, DBUS_TYPE_BOOLEAN, &_tmp23_);
	if (reply) {
		dbus_connection_send (connection, reply, NULL);
		dbus_message_unref (reply);
		return DBUS_HANDLER_RESULT_HANDLED;
...
static DBusHandlerResult _dbus_pipeline_ElementGetPropertyInt64 (Pipeline* self, DBusConnection* connection, DBusMessage* message) {
	...
	_g_free0 (property);
	_tmp38_ = val;
	dbus_message_iter_append_basic (&iter, DBUS_TYPE_INT64, &_tmp38_);
	_tmp39_ = result;
...
static DBusHandlerResult _dbus_pipeline_ElementGetPropertyString (Pipeline* self, DBusConnection* connection, DBusMessage* message) {
	...
	dbus_message_iter_next (&iter);
	element = g_strdup (_tmp40_);
	dbus_message_iter_get_basic (&iter, &_tmp41_);
	dbus_message_iter_next (&iter);
	property = g_strdup (_tmp41_);
	...
	_g_free0 (property);
	_tmp42_ = val;
	dbus_message_iter_append_basic (&iter, DBUS_TYPE_STRING, &_tmp42_);
	_g_free0 (val);
	_tmp43_ = result;
...
static DBusHandlerResult _dbus_pipeline_ElementGetPropertyBuffer (Pipeline* self, DBusConnection* connection, DBusMessage* message) {
	...
	dbus_message_iter_next (&iter);
	element = g_strdup (_tmp44_);
	dbus_message_iter_get_basic (&iter, &_tmp45_);
	dbus_message_iter_next (&iter);
	property = g_strdup (_tmp45_);
	data_length1 = 0;
	...
	_g_free0 (property);
	_tmp46_ = caps;
	dbus_message_iter_append_basic (&iter, DBUS_TYPE_STRING, &_tmp46_);
	_g_free0 (caps);
	_tmp47_ = data;
	dbus_message_iter_open_container (&iter, DBUS_TYPE_ARRAY, "y", &_tmp48_);
	for (_tmp49_ = 0; _tmp49_ < data_length1; _tmp49_++) {
		guint8 _tmp50_;
		_tmp50_ = *_tmp47_;
		dbus_message_iter_append_basic (&_tmp48_, DBUS_TYPE_BYTE, &_tmp50_);
		_tmp47_++;
	}
	dbus_message_iter_close_container (&iter, &_tmp48_);
	data = (g_free (data), NULL);
	_tmp51_ = result;
	dbus_message_iter_append_basic (&iter, DBUS_TYPE_BOOLEAN, &_tmp51_);
	if (reply) {
		dbus_connection_send (connection, reply, NULL);
		dbus_message_unref (reply);
		return DBUS_HANDLER_RESULT_HANDLED;
...
static DBusHandlerResult _dbus_pipeline_PipelineGetDuration (Pipeline* self, DBusConnection* connection, DBusMessage* message) {
	...
	dbus_message_iter_init_append (reply, &iter);
	_tmp52_ = result;
	dbus_message_iter_append_basic (&iter, DBUS_TYPE_INT64, &_tmp52_);
	if (reply) {
		dbus_connection_send (connection, reply, NULL);
		dbus_message_unref (reply);
		return DBUS_HANDLER_RESULT_HANDLED;
...
static DBusHandlerResult _dbus_pipeline_PipelineSeek (Pipeline* self, DBusConnection* connection, DBusMessage* message) {
	...
	dbus_message_iter_init_append (reply, &iter);
	_tmp55_ = result;
	dbus_message_iter_append_basic (&iter, DBUS_TYPE_BOOLEAN, &_tmp55_);
	if (reply) {
		dbus_connection_send (connection, reply, NULL);
		dbus_message_unref (reply);
		return DBUS_HANDLER_RESULT_HANDLED;
...
static DBusHandlerResult _dbus_pipeline_PipelineSkip (Pipeline* self, DBusConnection* connection, DBusMessage* message) {
	...
	dbus_message_iter_init_append (reply, &iter);
	_tmp58_ = result;
	dbus_message_iter_append_basic (&iter, DBUS_TYPE_BOOLEAN, &_tmp58_);
	if (reply) {
		dbus_connection_send (connection, reply, NULL);
		dbus_message_unref (reply);
		return DBUS_HANDLER_RESULT_HANDLED;
...
static DBusHandlerResult _dbus_pipeline_ElementSetState (Pipeline* self, DBusConnection* connection, DBusMessage* message) {
	...
	_g_free0 (element);
	_tmp63_ = result;
	dbus_message_iter_append_basic (&iter, DBUS_TYPE_BOOLEAN, &_tmp63_);
	if (reply) {
		dbus_connection_send (connection, reply, NULL);
		dbus_message_unref (reply);
		return DBUS_HANDLER_RESULT_HANDLED;
...
static void _dbus_pipeline_eo_s (GObject* _sender, guint64 pipe_id, DBusConnection* _connection) {
	...
	_tmp67_ = pipe_id;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_UINT64, &_tmp67_);
...
static void _dbus_pipeline_state_changed (GObject* _sender, guint64 pipe_id, const gchar* old_state, const gchar* new_state, const gchar* src, DBusConnection* _connection) {
	...
	dbus_message_iter_init_append (_message, &_iter);
	_tmp68_ = pipe_id;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_UINT64, &_tmp68_);
	_tmp69_ = old_state;
...
static void _dbus_pipeline_error (GObject* _sender, guint64 pipe_id, const gchar* err_message, DBusConnection* _connection) {
	...
	dbus_message_iter_init_append (_message, &_iter);
	_tmp72_ = pipe_id;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_UINT64, &_tmp72_);
	_tmp73_ = err_message;
...
static void _dbus_pipeline_qo_s (GObject* _sender, guint64 pipe_id, gboolean live, guint64 running_time, guint64 stream_time, guint64 timestamp, guint64 duration, gint64 jitter, gdouble proportion, gint quality, gint format, guint64 processed, guint64 dropped, DBusConnection* _connection) {
	...
	dbus_int64_t _tmp80_;
	double _tmp81_;
	dbus_int32_t _tmp82_;
	dbus_int32_t _tmp83_;
	dbus_uint64_t _tmp84_;
	...
	_tmp75_ = live;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_BOOLEAN, &_tmp75_);
	_tmp76_ = running_time;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_UINT64, &_tmp76_);
	_tmp77_ = stream_time;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_UINT64, &_tmp77_);
	_tmp78_ = timestamp;
	...
	_tmp80_ = jitter;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_INT64, &_tmp80_);
	_tmp81_ = proportion;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_DOUBLE, &_tmp81_);
	_tmp82_ = quality;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_INT32, &_tmp82_);
	_tmp83_ = format;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_INT32, &_tmp83_);
	_tmp84_ = processed;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_UINT64, &_tmp84_);
	_tmp85_ = dropped;
	dbus_message_iter_append_basic (&_iter, DBUS_TYPE_UINT64, &_tmp85_);
	dbus_connection_send (_connection, _message, NULL);
	dbus_message_unref (_message);
}
...
GType pipeline_get_type (void) {
	...
	if (g_once_init_enter (&pipeline_type_id__volatile)) {
		...
		g_type_set_qdata (pipeline_type_id, g_quark_from_static_string ("DBusObjectVTable"), (void*) (&_pipeline_dbus_vtable));
